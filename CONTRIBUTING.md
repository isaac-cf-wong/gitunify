# Contributing to gitunify

🎉 Thank you for your interest in contributing to `gitunify`!
...
1. Open an Issue
    ...
    [Open an issue](https://github.com/isaac-cf-wong/gitunify/issues/new/choose)
...
2. Fork and Clone the Repository
    ...
    ```shell
    git clone git@github.com:<username>/gitunify.git
    cd gitunify
    ```
...
Thanks again for being part of the `gitunify` community!
